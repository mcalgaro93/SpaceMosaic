# Legacy SpatialExperiment-based differential-expression interface.
#
# Retained as commented reference code while the package transitions to the
# matrix-based hastyDE() and patchDE() implementations in R/DE.R.
#
#
